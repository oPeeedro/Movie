...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/moviesstorefront/electronics/en",
						"https://electronics.local:9002/moviesstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/moviesstorefront/electronics/en",
						"https://electronics.local:9002/moviesstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/moviesstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/moviesstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/moviesstorefront/electronics/en",
						"https://electronics.local:9002/moviesstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/moviesstorefront",
						"https://electronics.local:9002/moviesstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/moviesstorefront",
						"https://electronics.local:9002/moviesstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/moviesstorefront/electronics/en",
						"https://electronics.local:9002/moviesstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
