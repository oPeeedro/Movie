 ...
 */
package moviestorefront.service.impl;
...
public class DefaultMoviestorefrontService implements MoviestorefrontService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMoviestorefrontService.class);
	...
	{
		return DefaultMoviestorefrontService.class.getResourceAsStream("/moviestorefront/sap-hybris-platform.png");
	}
